...
// ===================== MIE FUNTIONS ============
static  OS_TCB       AppTaskGREENTCB;
static  CPU_STK      AppTaskGREENStk[APP_CFG_TASK_START_STK_SIZE];
static  OS_TCB       AppTaskREDTCB;
static  CPU_STK      AppTaskREDStk[APP_CFG_TASK_START_STK_SIZE];
...
//                  0u,
//                  0u,
//                 (OS_OPT_TASK_STK_CHK | OS_OPT_TASK_STKC_LR | OS_OPT_TASK_SAVE_FP),
//                 &err);

    // BEGIN GREEN
    OSTaskCreate(&AppTaskGREENTCB,
                     "AppTaskGREEN",
					 AppTaskGREEN,
                      0u,
                      APP_CFG_TASK_START_PRIO,
